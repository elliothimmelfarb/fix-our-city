...
function googleMapLoader(bootstrapURLKeys) {
  ...
  loadPromise_ = new Promise(function (resolve, reject) {
    ...
    $script_(`https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyC2Ljl_7KIYLlF7oui-0nmd5p-phCzamUo&callback=_$_google_map_initialize_$_`, function () {
...
// 'https://maps.googleapis.com/maps/api/js?libraries=places&callback=_$_google_map_initialize_$_' + queryString
